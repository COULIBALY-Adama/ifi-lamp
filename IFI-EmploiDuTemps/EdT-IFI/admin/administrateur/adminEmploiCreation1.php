...
<form method="POST" action="adminEmploiCreation.php" name="form1">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr> 
      ...
      <td colspan="3" height="32" bgcolor="#00FFFF">Copie de Semaine: 
        <select name="ListeSemaineCopie">
          <?php /*
		for ($i=1; $i<=$fldNombreDeSemaine; $i++) {
			echo "<option value=\"" . $i . "\"";
			if ($i==$semaineselected) echo "SELECTED ";
    ...
    <tr bgcolor="#CCFFCC"> 
      <td colspan="7" height="26" bgcolor="#00FFAA"> 
        <div align="right">
          ...
          <a href="adminEmploiCreation.php?SemaineSelected=<?php echo  $semaineselected-1?>&EmploiID=<?php echo $emploiID?>"><b>Précédente</b></a>
