...
// printf ("Debug :submit = %s, FormName = %s, FormAction = %s, FormType =%s\n", $submit, $formName, $formAction, $formType); // Quang added
	if ($submit) // do action
		switch ($submit) {
...
<?php		}
				...
				<a href="adminListeEmploi.php?PageNumber=<?php echo $iPage-1?>">Pr&eacute;c&eacute;dente</a>
<?php		}
